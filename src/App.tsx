          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
              ...
              <div>
                ...
                <ul className="space-y-3 sm:space-y-4">
                  <li><a href="#" className="text-[#939090] hover:text-white transition-colors duration-300 text-sm tracking-wider">Twitter</a></li>
                  <li><a href="#" className="text-[#939090] hover:text-white transition-colors duration-300 text-sm tracking-wider">LinkedIn</a></li>
                  <li>
                    <a href="#" className="text-[#939090] hover:text-white transition-colors duration-300 text-sm tracking-wider inline-flex items-center space-x-2">
